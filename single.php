		...
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<section class="article-wrap">
				...
				<div class="post-details">
					...
					<span class="comments"><?php comments_popup_link( __( 'Leave your thoughts', 'ampnetmedia' ), __( '1 Comment', 'html5blank' ), __( '% Comments', 'html5blank' )); ?></span>
				</div>
				<!-- /post details -->
				<?php the_content(); // Dynamic Content ?>
			</section>
			<?php the_tags( __( 'Tags: ', 'ampnetmedia' ), ', ', '<br>'); // Separated by commas with a line break at the end ?>
			
			<p><?php _e( 'Categorised in: ', 'ampnetmedia' ); the_category(', '); // Separated by commas ?></p>
