...
<div id="respond" class="container">
	...
	<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform" role="form" class="col-xs-12 col-sm-8 col-md-6">
...
//				<input class="form-control" type="text" name="url" id="url" value="<?php echo esc_attr($comment_author_url); ?><?php //" size="22" tabindex="3" />
//			</div>
?>
		<?php endif; ?>
